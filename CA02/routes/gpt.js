...
router.post("/gpt", async (req, res) => {
    try {
        const prefix = "You are to assist with learning Mandarin. Reply in Mandarin and explain as an experienced teacher what your response means in english. Please reference characters for detailed explanations: ";
